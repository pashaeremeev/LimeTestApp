...
public class FavoriteChannelsFragment extends Fragment {
    ...
    private void createChannelField(ViewGroup parent, String nameOfChannel, boolean isFav, int idIcon) {
        ...
        paramsOfField.setMargins(HORIZONTAL_MARGIN, VERTICAL_MARGIN, HORIZONTAL_MARGIN, VERTICAL_MARGIN);
        ...
        field.setBackground(getResources().getDrawable(R.drawable.bg_rounded, getContext().getTheme()));
