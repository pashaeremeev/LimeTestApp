...
public final class TrackSelectionDialog extends DialogFragment {
    ...
    public View onCreateView(
        ...
        View dialogView = inflater.inflate(layout.track_selection_dialog, container, false);
        TabLayout tabLayout = dialogView.findViewById(id.track_selection_dialog_tab_layout);
        ViewPager viewPager = dialogView.findViewById(id.track_selection_dialog_view_pager);
        Button cancelButton = dialogView.findViewById(id.track_selection_dialog_cancel_button);
        Button okButton = dialogView.findViewById(id.track_selection_dialog_ok_button);
